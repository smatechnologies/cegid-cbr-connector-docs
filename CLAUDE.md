# Cegid CBR Connector Documentation — Claude Code Project

This repository contains the Cegid CBR Connector product documentation site built with Docusaurus.
